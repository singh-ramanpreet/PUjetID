...
options.register ('dataEra', "RunA", VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string)
options.parseArguments()
dataEra = options.dataEra
print(dataEra)

from CondCore.CondDB.CondDB_cfi import CondDB
CondDBJECFile = CondDB.clone(connect = cms.string('sqlite:Summer19UL18_%s_V5_DATA.db' % dataEra))
process.jec = cms.ESSource(
    'PoolDBESSource', CondDBJECFile,
    toGet = cms.VPSet(
        cms.PSet(record = cms.string('JetCorrectionsRecord'),
                 tag = cms.string('JetCorrectorParametersCollection_Summer19UL18_%s_V5_DATA_AK4PFchs' % dataEra),
                 label = cms.untracked.string('AK4PFchs')),
        cms.PSet(record = cms.string('JetCorrectionsRecord'),
                 tag = cms.string('JetCorrectorParametersCollection_Summer19UL18_%s_V5_DATA_AK4PFPuppi' % dataEra),
