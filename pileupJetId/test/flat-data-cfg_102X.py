...
#process.GlobalTag.globaltag = '102X_dataRun2_Prompt_v15' # for 2018D

##-------------------- Define the source  ----------------------------
process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(-1))
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
  " /store/data/Run2018C/DoubleMuon/MINIAOD/17Sep2018-v1/60000/66EBF22C-2305-4645-B717-6DD4D3802391.root"
  )
)
