...
CondDBJECFile = CondDB.clone(connect = cms.string('sqlite:Summer19UL16_RunBCDEFGH_V5_DATA.db'))
process.jec = cms.ESSource(
    'PoolDBESSource', CondDBJECFile,
    toGet = cms.VPSet(
        cms.PSet(record = cms.string('JetCorrectionsRecord'),
                 tag = cms.string('JetCorrectorParametersCollection_Summer19UL16APV_RunBCDEF_RunGH_V5_DATA_AK4PFchs'),
                 label = cms.untracked.string('AK4PFchs')),
        cms.PSet(record = cms.string('JetCorrectionsRecord'),
                 tag = cms.string('JetCorrectorParametersCollection_Summer19UL16APV_RunBCDEF_RunGH_V5_DATA_AK4PFPuppi'),
...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    'root://cmsxrootd.fnal.gov//store/data/Run2016C/DoubleMuon/MINIAOD/21Feb2020_UL2016_HIPM-v1/20000/017D4BF8-472D-0A41-BFD7-E8093539C245.root'
  )
)
