...
pujetidFullId, pujetidFullIdLabel = Handle("edm::ValueMap<int>") , "pileupJetId:fullId"                                                                                                                                                                                                                                                                                                                                          
vertices, vertexLabel = Handle("std::vector<reco::Vertex>"), "offlinePrimaryVertices"                                                                                                                                                                                                                                                                                                
                                                                                                                                                                                                                                                                                                                                                                                        
# open file (you can use 'edmFileUtil -d /store/whatever.root' to get the physical file name)                                                                                                                                                                                                                                                                                               
events = Events("file:////afs/cern.ch/user/h/hinzmann/workspace/tmp/patTupleUpdatedFromAODzmm.root")
